...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  commodity: {
    title: 'Lodestar · Supply-chain command centre',
    description: 'Live supply-chain command centre for a medical imaging OEM. Demo: OEM figures are synthetic and labelled.',
    keywords: '',
    url: 'https://lodestar-command.vercel.app/dashboard',
    siteName: 'Lodestar',
    shortName: 'Lodestar',
    subject: 'Supply-chain command centre',
    classification: 'Supply-chain command centre',
